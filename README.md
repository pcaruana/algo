...
> [Go study guide →](https://github.com/pcaruana/work-mate-go)


## Motivation

Keeping some tracking of most frequently appeared coding interview problems
that provided me valuable and productive to spend time on. For each
one, some brainstorming about process on how to approach and solve it,
adding well-documented solutions with test cases, time and space complexity
analysis. May this help you get good algorithms and data structures so
